		      ...
		      <legend>Identifier</legend> 
		       <div class="row">
				...
				<div class="row">
					...
					<div class="colr-20">
						<select id="Designation" name="Designation"  onkeypress="DesignationValidation(event)" style="width: 335px;">							
				...
				<div class="row">	
					...
					<div class="col-20">
						<select id="GenderType" name="GenderType" onkeypress="GenderValidation(event)" style="width: 325px;" >
					...
					<div class="colr-20">
						<select id="ReligionType" name="ReligionType" style="width: 335px;">
				...
				<div class="row">
					...
					<div class="colr-20">
						<select id="PensionType" name="PensionType" style="width: 335px;">
				 ...
				 <div class="row">				
					...
					<div class="col-20">
					   ...
					   <div class="colr-15">
						...
						<div class="colr-20">
							<select id="ActivationType" name="ActivationType"  maxlength="45" onkeypress="ActivationTypeValidator(event)" style="width: 335px;">
