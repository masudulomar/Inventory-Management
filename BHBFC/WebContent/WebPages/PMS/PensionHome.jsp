...
function InitValues(){
	...
	if(userRole=="null"){
		...
		document.getElementById("EmployeeName").innerHTML = "Welcome to Office Management System(OMS) of Bangladesh House Building Finance Corporation ";
	}
}
...
<center><p> <%-- Hello <%= session.getAttribute("USER_NAME")%>,  --%></p></center>
 ...
 <div class="container" style = "position:relative; top:20px;"> 
    <h3 id="WelcomeMsg">Welcome to Pension Management System(PMS) of Bangladesh House Building Finance Corporation 
    which is specially designed and developed to generate monthly Pension of this corporation as 
    well as festival  bonuses.</h3>
 </div>
 ...
 <br><br><br><br>
	...
	<div class="alert">
			...
			<a href="http://192.168.100.221:8080/PRMS/" target="_blank" style="color:white"> Alternative Server</a>
		</div>
