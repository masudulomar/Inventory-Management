...
{	    
	...
	var usr_brn = "<%= session.getAttribute("BranchCode")%>";	
	var DataString="loggedBranch="+usr_brn+"&ReportType=PersonalLedger"+
	"&FinYear="+document.getElementById("FinYear").value+
	"&BranchCode="+document.getElementById("BranchCode").value+
	"&PrintType="+document.getElementById("ReportType").value+
	"&LoanCodeNo="+document.getElementById("LoanCodeNo").value;
...
<body onload="initValues()">
		<center>
		<h2 style="color:#006600;">Personal Loan A/C Statement </h2>
		...
		<fieldset>	
		   <legend>Report Parameter</legend> 			
				...
				<div class="row">
					<div class="col-25">
						<label for="LoanCodeNo">Loan Code(13 digit)</label>
					</div>
					<div class="col-45">
						<input type="text" id="LoanCodeNo" name="LoanCodeNo" onkeypress="LoanCodeNoValidation(event)">
					</div>
				</div>
