...
<body onload="InitValues()">
    ...
    <img src="../../Media/Header.png" alt=""/>
		...
		<div>
			<iframe height="1500px" width="84.4%" src="../Welcome.jsp" name="contents_1" frameBorder="0" style="border: 1px solid green;"> </iframe>
			<iframe height="1500px" width="15%" src="../Aside.jsp" name="contents_2" style="border: 1px solid green;"></iframe>
		</div>
