				...
				<div class="row">
					...
					<div class="col-15">
						<select id ="UserRole"  onkeypress="UserRoleKeyPress(event)" style="width: 227px;">			        		
			        		...
			        		<option  value="K">Branch Office User</option>	
			        		<option  value="G">Head Office User</option>
			        		<option  value="H">HRM User</option>
			        		<option  value="P">PNPS User</option>
			        		<option  value="Q">MIS[Admin] USer</option>	
			        		<option  value="1">MIS[Law] USer</option>	
			        		<option  value="2">MIS[Loan] USer</option>	
			        		<option  value="3">MIS[Audit] USer</option>	
			        		<option  value="4">MIS[Management] USer</option>	
			        		<option  value="5">MIS[Recovery] USer</option>	
			        		<option  value="6">MIS[Kharidabari] USer</option>	
