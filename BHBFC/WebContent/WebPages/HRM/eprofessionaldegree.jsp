...
<script type="text/javascript">
	...
	arrHead = [ 'Activity', 'PF No & Name','Name of Exam', 'Exam Year', 'Result','Organization Name' ];
    ...
    function submitTransaction() {
	  ...
	  if (c == true) {
      	...
      	SetValue("Class", "AdminOperation","N");
		SetValue("Method", "SaveProfessional","L");	
      	xmlFinal();
	...
	<fieldset>
		...
		<div class="container">
			...
			<div class="row">
				 ...
				 <div class="col-15">
					<label for="NameofExam">Exam. Name </label>
				</div>
				...
				<div class="col-15">
					<label for="ExamYear">Year of Exam </label>
				</div>
			...
			<div class="row">
				...
				<div class="col-20">
					<input type="text" id="OrganizationName" name="OrganizationName" onkeypress="OrganizationNameValidation(event)">
				</div>
