...
<body onload="initValues()">
		<center>
		<h2 style="color:#006600;">Designation Wise Employee Report</h2>
		...
		<fieldset>	
		   <legend> Parameter</legend> 	
					...
					<div class="row">
						...
						<div class="col-45">
						<select id="BranchCode" name="BranchCode" style="width: 260px;">						
						</select>
					   </div>
					</div>
				 ...
				 <div class="row">
					<div class="col-25">
						<label for="newDesignation">Designation Name </label>
					</div>
	
					<div class="col-45">
						<select id="newDesignation" name="newDesignation" style="width: 260px;">						
						</select>
					</div>
				</div>	
				...
				<div class="col-25">
					...
					<div class="col-45">
					<select id="DeptName" name="DeptName" style="width: 260px;">						
					</select>
				</div>
				</div>											
				<div class="row">
					...
					<div class="col-45">
						<select id="ReportType" name="ReportType"  style="width: 260px;">							
							<option value="rdesignationWiseEmployeeReport">Print Report </option>
						</select>
					</div>
				</div>
				</fieldset>
