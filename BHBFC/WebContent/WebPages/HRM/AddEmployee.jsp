	...
	<h3>[Add/Modify Information]</h3>
		<div class="container">
				...
				<div class="row">
					...
					<div class="colr-20">
						<select id="Designation" name="Designation"  onkeypress="DesignationValidation(event)" style="width: 250px;">							
							...
							<option value="36">Maintenance Engineer</option>
							<option value="37">Maintenance Engineer (Network)</option>
				...
				<div class="row">
					...
					<div class="colr-20">
						<select id="DeptCode" name="DeptCode" onkeypress="DeptCodeValidation(event)" style="width: 250px;">
				...
				<div class="row">	
					...
					<div class="col-20">
						<select id="GenderType" name="GenderType" onkeypress="GenderValidation(event)" style="width: 250px;" >
					...
					<div class="colx-15">
						<select id="Rhfactor" name="Rhfactor" onkeypress="RhfactorValidation(event)" style="width: 138px;">
				...
				<div class="row">
					...
					<div class="col-20">
						<select id="ReligionType" name="ReligionType" style="width: 250px;">
