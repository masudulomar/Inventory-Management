...
function SetValue(key,value,itemsl){
	...
	function loadOfficeOrder(){
		...
		SetValue("Method", "GetOfficeOrderList","L");
		xmlFinal();
		$.ajax({
			  method: "POST",
			  ...
			  .done(function( responseMessage ) {
			    ...
			    if (obj.ERROR_MSG != "") {
					...
					var select = document.getElementById("officeOrder");   					
...
{	    
	...
	"&officeOrder="+document.getElementById("officeOrder").value;
		...
		xhttp.open("POST", "FileDownloadHandler?"+DataString, true);
...
<body onload="initValues()">
		<center>
		 <h3> Download Office order in HRM System </h3>
		...
		<fieldset>	
		   <legend> Parameter</legend> 	
			     ...
			     <div class="row">
					<div class="col-15">
						<label for="officeOrder">Office Order</label>
					</div>
		
					<div class="col-20">
						<select id="officeOrder" name="officeOrder" style="width: 450px;">						
						</select>
					</div>					
				</div>  
				...
				<div class="row">
					...
					<div class="col-20">
						<select id="ReportType" name="ReportType"  style="width: 260px;">							
							<option value="rDownloadOrder">Print Report </option>
						</select>
					</div>
				</div>
				</fieldset>
				<div class="row">
					...
					<div class="col-20">
						<input type="submit" id="report_download" value="Downloand" onclick="ViewAllReport()" > <br>
					</div>
