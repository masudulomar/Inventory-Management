...
<script type="text/javascript">
	...
	arrHead = [ 'Activity', 'PF No & Name','Reward Name', 'Reward Description', 'Reward By','Reward Date' ];
        ...
        for (var c = 0; c < arrHead.length; c++) {
            ...
            if (c == 0) {      // the first column.
                ...
                if(c==2){
                	 var ele = document.createElement('input');
                     ele.setAttribute('type', 'text');
              	      ele.setAttribute('value', document.getElementById("RewardName").value);
              	      ele.setAttribute("readonly", true);
              	      td.appendChild(ele);
                }
                if (c==3){
                	 ...
                	 var ele = document.createElement('input');
                     ele.setAttribute('type', 'text');
              	      ele.setAttribute('value', document.getElementById("RewardDescription").value);
              	      ele.setAttribute("readonly", true);
              	      td.appendChild(ele);
                }                                               
                if (c==4){
                	 var ele = document.createElement('input');
                     ele.setAttribute('type', 'text');
                  	 ele.setAttribute('value', document.getElementById("RewardBy").value);
                  	 ele.setAttribute("readonly", true);
                  	td.appendChild(ele);
                  } 
                ...
                if (c==5){
                	 var ele = document.createElement('input');
                     ele.setAttribute('type', 'text');
                  	 ele.setAttribute('value', document.getElementById("RewardDate").value);
                  	 ele.setAttribute("readonly", true);
                  	 td.appendChild(ele);
                 }  
            }
    ...
    function AddToList(event){
    	 ...
    	 if(document.getElementById("RewardName").value=="" 
  			||document.getElementById("RewardDescription").value==""
  			||document.getElementById("RewardBy").value=="" 
    ...
    function RewardNameValidation(event){
    	if (event.keyCode == 13 || event.which == 13) {
    		document.getElementById("RewardDescription").focus();      
    	}
    }

    function RewardDescriptionValidation(event){
    	if (event.keyCode == 13 || event.which == 13) {
    		document.getElementById("RewardBy").focus();      
    	}
    }
    
    function RewardByValidation(event){
    	if (event.keyCode == 13 || event.which == 13) {
    		document.getElementById("RewardDate").focus();      
    	}
    }
    
    function RewardDateValidation(event){
    	if (event.keyCode == 13 || event.which == 13) {
    		AddToList(event);  
    	}
    }
    ...
    function submitTransaction() {
	  ...
	  if (c == true) {
      	...
      	SetValue("Class", "AdminOperation","N");
		SetValue("Method", "SaveAwardData","L");	
      	xmlFinal();
...
<body onload="initValues()">
 <center> <p>Reward Information Entry</p></center>
	<fieldset>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-20">
					<input type="text" id="RewardName" name="RewardName" style="width: 400px;" onkeypress="RewardNameValidation(event)">
				</div>
			...
			<div class="row">
				...
				<div class="col-20">
					<input type="text" id="RewardDescription" name="RewardDescription" style="width: 400px;" onkeypress="RewardDescriptionValidation(event)">
				</div>
			...
			<div class="row">
				<div class="col-15">
					<label for="RewardBy">Reward By </label>
				</div>

				<div class="col-20">
					<input type="text" id="RewardBy" name="RewardBy" onkeypress="RewardByValidation(event)">
				</div>
								
				<div class="col-15">
					<label for="RewardDate">Date of Reward</label>
				</div>

				<div class="col-20">
					<input type="text" id="RewardDate" name="RewardDate" onkeypress="RewardDateValidation(event)">
				</div>				
			</div>	
