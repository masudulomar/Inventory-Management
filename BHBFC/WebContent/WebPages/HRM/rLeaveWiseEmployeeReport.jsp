...
<body onload="initValues()">
		<center>
		<h2 style="color:#006600;"> Employee Leave Related Report</h2>
		...
		<fieldset>	
		   <legend> Parameter</legend> 	
				...
				<div class="row">
					...
					<div class="col-45">
					<select id="LeaveType" name="LeaveType" style="width: 260px;">						
					</select>
				   </div>
				</div>
				...
				<div class="row">
					...
					<div class="col-45">
						<select id="ReportType" name="ReportType"  style="width: 260px;">							
							<option value="rLeaveWiseEmployeeReport">Print Report </option>
						</select>
					</div>
				</div>
				</fieldset>
