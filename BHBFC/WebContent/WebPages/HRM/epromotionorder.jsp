...
<script type="text/javascript">
	...
	arrHead = [ 'Activity', 'PF No & Name', 'Grade',
			'Posted Branch','Posted Designation', 'Attached Dept.' ];
    	...
    	$.ajax({
    		  ...
    		  .done(function( responseMessage ) {
    		    ...
    		    if (obj.ERROR_MSG != "") {
    				...
    				var select = document.getElementById("newDesignation");                  
    				 var item_arrayList = item_srting.split(',');
    				 for(var i = 0; i < item_arrayList.length; i++) {
    					 item_arrayList[i] = item_arrayList[i].replace("/^\s*/", "").replace("/^\s*/", "");							 
    					    var item_keyValue = item_arrayList[i].split(':');
        ...
        for (var c = 0; c < arrHead.length; c++) {
            ...
            if (c == 0) {      // the first column.
                ...
                if(c==2){
                	 var ele = document.createElement('input');
                     ele.setAttribute('type', 'text');
              	      ele.setAttribute('value', document.getElementById("Grade").value);
              	      ele.setAttribute("readonly", true);
              	      td.appendChild(ele);
                }
                if (c==3){
                ...
                if (c==4){
                	 var ele = document.createElement('input');
                     ele.setAttribute('type', 'text');
                  	 ele.setAttribute('value', document.getElementById("newDesignation").value);
                  	 ele.setAttribute("readonly", true);
                  	td.appendChild(ele);
                  } 
    ...
    function AddToList(event){
    	 ...
    	 if(document.getElementById("BranchCode").value=="" ||document.getElementById("NewBranch").value==""||document.getElementById("newDesignation").value=="" 
   		 ...
   		 if (document.getElementById("OfficeOrderNo").value==""|| document.getElementById("orderDate").value==""){
   		 ...
   		 }else
   			 {
   		        ...
   		        SetValue("EffectiveDate", document.getElementById("EffectiveDate").value,"N");
   		      	...
   		      	SetValue("Class", "AdminOperation","N");
   				SetValue("Method", "PromotionOrderPosting","L");	
   		      	xmlFinal();
	...
	<fieldset>
		...
		<div class="container">
			...
			<div class="row">
			   <div class="col-15">
				...
				<div class="col-20">
					<select id="newDesignation" name="newDesignation">						
					</select>
				</div>
		...
		<div class="containerfooter">
			...
			<div class="row">
				...
				<div class="col-20">
					<input type="text" id="EffectiveDate" value=""
						onkeypress="OrderDateValidation(event)">
				</div>
