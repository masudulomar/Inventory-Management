...
{	    
	...
	+"&CatagoryType="+document.getElementById("CatagoryType").value;
...
<body onload="initValues()">
		<center>
		<h2 style="color:#006600;">Category Wise Organogram Report</h2>
		...
		<fieldset>	
		   <legend> Parameter</legend> 	
		        ...
		        <div class="row">
					<div class="col-25">
							<label for="CatagoryType">Office Category</label>
					</div>
					<div class="col-45">
						<select id="CatagoryType" name="CatagoryType"  style="width: 260px;">							
							<option value="A">A- Category </option>	
							<option value="B">B- Category </option>	
							<option value="C">C- Category </option>	
							<option value="Z">Z- Zonal </option>	
							<option value="R">R- Regional </option>	
							<option value="H">H- Head Office </option>							
						</select>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-45">
						<select id="ReportType" name="ReportType"  style="width: 260px;">							
							<option value="rCatagoryWiseOrganogramSummaryReport">Print Report </option>							
						</select>
					</div>
				</div>
				</fieldset>
