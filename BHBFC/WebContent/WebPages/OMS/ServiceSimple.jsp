...
function LoanAccValidation(event){
		...
		SetValue("LoanAcc", document.getElementById("LoanAcc").value);
		SetValue("LocationCode", document.getElementById("LocationCode").value);
		SetValue("LocationCatagory", document.getElementById("LocationCatagory").value);
		SetValue("Class", "ServiceValidation");
		SetValue("Method", "FetchAccountDetails");	
	 ...
	 if (!validateEmail(document.getElementById("MailAddress").value)) {
		 alert(document.getElementById("MailAddress").value + " is not valid ");
			...
			if(!(inputText.match(phoneno))){
				...
				SetValue("LocationCode", document.getElementById("LocationCode").value);
				SetValue("LocationCatagory", document.getElementById("LocationCatagory").value);
				SetValue("MailAddress", document.getElementById("MailAddress").value);
				SetValue("PhoneAddress", document.getElementById("PhoneAddress").value);	
				SetValue("Class","ServiceValidation");
				SetValue("Method","UpdateBorrowerDeduction");
...
<body onload="initValues()">
	<center>
		<div class="container">
		   	<h3>Service Simplification Page</h3>
		      <fieldset>
