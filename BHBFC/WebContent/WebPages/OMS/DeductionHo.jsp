...
<body onload="initValues()">
		<center>
		<h2 style="color:#006600;">[All Deduction Report for all Branch]</h2>
				...
				<div class="row">
					...
					<div class="col-75">
						<select id="ReportType" name="ReportType" >	
						    <option value="AllDeduction">All Deduction Summary</option>						
		...
		<form action="ReportModule.jsp">
         	<Button class="taxButton" style="vertical-align:middle"><span>Report Module </span></Button>
        </form>	
