...
<div class="header">
    <img src="../../Media/Header.png" alt=""/>
		...
		<div class="topnav" style="align: center">
			   ...
			   <a class="active" href="DefaultUserjsp.jsp"><i class="fa fa-fw fa-home" ></i>Home</a> 			   
			   ...
			   <div class="dropdown">
					...
					<div class="dropdown-content">	
					    ...
					    <a href="eloanrecoverable.jsp" target="contents_1"><i class="fa fa-user-plus" ></i> Loan Recoverable </a>
						 <a href="rrecoveryreportpage.jsp" target="contents_1"><i class="fa fa-download" ></i> Recovery & Recoverable  </a>						
					</div>
			   </div>
