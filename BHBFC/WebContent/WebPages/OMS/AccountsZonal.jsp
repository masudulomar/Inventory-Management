...
<body onload="initValues()">
    ...
    <img src="../../Media/Header.png" alt=""/>
		...
		<div class="navbar" style="height: 100%">
			...
			<div class="dropdown">
				<button class="dropbtn">PRMS [Report]<i class="fa fa-caret-down"></i>
				</button>
				<div class="dropdown-content">
			...
			<div class="dropdown">
				<button class="dropbtn"> MIS Report Module <i class="fa fa-caret-down"></i>
				</button>
				
				<div class="dropdown-content">
					<a href="MISBranchWiseReporting.jsp" target="contents_1"><i class="fa fa-download" style="font-size: 15px"></i> Item  Wise [Branch]</a>
					<a href="MISBranchWiseReport.jsp" target="contents_1"><i class="fa fa-download" style="font-size: 15px"></i> Summary Report [Branch]</a>
					<a href="MISSummaryReport.jsp" target="contents_1"><i class="fa fa-download" style="font-size: 15px"></i> Summary Report[All]</a>
				</div>
			</div>
