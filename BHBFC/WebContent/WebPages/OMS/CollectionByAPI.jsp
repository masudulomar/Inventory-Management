...
<body onload="initValues()">
		<center>
		<h2 style="color:#006600;">API Related Report</h2>
				...
				<div class="row">
					...
					<div class="col-45">
						<select id="ReportType" name="ReportType"  style="width: 260px;">							
							<option value="FeesCollection">Print Details Collection By SBL API</option>
							<option value="FeesCollectionSummary">Print Summary By SBL API</option>
							<option value="FeesCollectionPurpose">Print Purpose Wise Summary By SBL API</option>
