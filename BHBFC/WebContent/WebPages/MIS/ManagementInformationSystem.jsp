...
<body onload="initValues()">
    ...
    <img src="../../Media/Header.png" alt=""/>
		...
		<div class="navbar" style="height: 100%">
			<a class="active" href="ManagementInformationSystem.jsp"><i class="fa fa-fw fa-home" style="font-size: 15px"></i>Home</a> 
			...
			<div class="dropdown">
				...
				<div class="dropdown-content">	
					<a href="TargetMaster.jsp" target="contents_1"><i class="fa fa-plus-circle" style="font-size: 15px"></i> Target Master</a>								
					<a href="TergetSetupEntryPages.jsp" target="contents_1"><i class="fa fa-plus-circle" style="font-size: 15px"></i> Target Setup</a>														
				</div>
			</div>	
			...
			<div class="dropdown">
				...
				<div class="dropdown-content">
				    ...
				    <a href="MISLoanSanctionHO.jsp" target="contents_1"><i class="fa fa-plus-circle" style="font-size: 15px"></i> Loan Sanction </a>
				    <a href="MISLoanDisburseHO.jsp" target="contents_1"><i class="fa fa-plus-circle" style="font-size: 15px"></i> Loan Disbursement</a>
					<a href="MISLoanRecoveryHO.jsp" target="contents_1"><i class="fa fa-plus-circle" style="font-size: 15px"></i> Loan Recovery</a>
					...
					<a href="MISKharidabariHO.jsp" target="contents_1"><i class="fa fa-plus-circle" style="font-size: 15px"></i> Kharidabari</a>
					<a href="MISCourtCaseSettlementHO.jsp" target="contents_1"><i class="fa fa-plus-circle" style="font-size: 15px"></i> Court Case Settlement</a>
					<a href="MISDeedReturnFaultyCasesHO.jsp" target="contents_1"><i class="fa fa-plus-circle" style="font-size: 15px"></i> Deed Return From Faulty Loan Cases</a>
				</div>
			</div>
