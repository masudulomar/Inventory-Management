...
{	    
	...
	var usr_brn = "<%= session.getAttribute("BranchCode")%>";	
	var DataString="BranchCode="+usr_brn+"&ReportType="+document.getElementById("ReportType").value+
				...
				<div class="row">
					...
					<div class="col-75">
						<select id="ReportType" name="ReportType" >
							<option value="misConsolidateReport"> Summary Report[Loan sanction, disburse,recovery]</option>
							<option value="misConsolidateReportOthers"> Summary Report[Audit, Court Case,Kharidabari,Deed Return]</option>					
						</select>
					</div>
				</div>
				</fieldset>
