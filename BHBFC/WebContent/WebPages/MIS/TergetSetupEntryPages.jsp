  		    ...
  		    var obj = JSON.parse(responseMessage);
	  		  if (obj.ERROR_MSG != "") {
					...
					initValues();
						...
						document.getElementById("govtloan").value=obj.GOV_LOAN;
				}
  	});	
}
...
{			
		...
		SetValue("govtloan",document.getElementById("govtloan").value,"N");		
		SetValue("Class","MISDataValidation","N");
		...
		<div class="container">
		      ...
		      <legend>Target Identifier</legend> 
				...
				<div class="row">	
					...
					<div class="col-15">
						<label for="govtloan">Govt. Disburse </label>
					</div>
					<div class="col-15">
						<input type="text" id="govtloan" name="govtloan" onkeypress="govtloanDisburseValidation(event)">
					</div>	
					<div class="col-15">
