...
var usr_brn = "<%= session.getAttribute("BranchCode")%>";	
	...
	"&BranchCode="+document.getElementById("BranchCode").value+"&TargetCode="+document.getElementById("TargetCode").value;  
...
<body onload="initValues()">
		<center>
		<h2 style="color:#006600;"> Zone Wise Summary Report</h2>
		...
		<fieldset>	
				...
				<div class="row">
					<div class="col-25">
							<label for=BranchCode>Zone </label>
					</div>
					<div class="col-75">
						<select id="BranchCode" name="BranchCode" >						   
							<option value="0100Z">Chattogram Zonal Office</option>
							<option value="0200Z">Khulna Zonal Office</option>	
							<option value="0300Z">Rajshahi Main</option>
							<option value="0400Z">Barishal Zonal Office</option>
							<option value="0500Z">Sylhet Zonal Office</option>
							<option value="0600Z">Zonal Office,Dhaka North</option>	
							<option value="0800Z">Sadar Main </option>
							<option value="2001Z">Faridpur Zonal Office</option>							
							<option value="4000Z">Mymensingh Zonal Office</option>															
							<option value="5000Z">Rangpur Zonal Office</option>																
						</select>
					</div>
				</div>			  	
				...
				<div class="row">
					...
					<div class="col-75">
						<select id="ReportType" name="ReportType" >
						    <option value="ZoneWiseSummary">Zone Wise Summary Report</option>
