...
function initValues(){	
	...
	LoadTarget();
	document.getElementById("ParentTargetCode").value = "";
				...
				if (obj.TARGET_DESCRIPTION!=null) {
					var r = confirm("Target already exists!\nDo you want to update?");
					  if (r == true) {	
							...
							document.getElementById("TargetType").value = obj.ACTIVATION;
							document.getElementById("ParentTargetCode").value = obj.PARENT_CODE;
...
function LoadTarget(){
	...
	clear();	
	SetValue("Class", "MISDataValidationHO","N");
	SetValue("Method", "FetchTargetParentList","L");
	xmlFinal();
	$.ajax({
		  method: "POST",
		  url: "TransactionServlet",
		  ...
		  .done(function( responseMessage ) {
		    ...
		    if (obj.ERROR_MSG != "") {
				...
				var select = document.getElementById("ParentTargetCode");                  
...
{			
		...
		SetValue("ParentTargetCode",document.getElementById("ParentTargetCode").value,"N");
		SetValue("TargetType",document.getElementById("TargetType").value,"N");		
		...
		<div class="container">
		      ...
		      <legend>Target Identifier</legend> 
		       ...
		       <div class="row">
				...
				<div class="row">
					<div class="col-15">
						<label for="ParentTargetCode">Parent Target Code</label>
					</div>
					<div class="col-75">
					<select id="ParentTargetCode" name="ParentTargetCode">						
					</select>
				</div>
				</div>	
				...
				<div class="row">
					...
					<div class="col-20">
						<select id="TargetType" name="TargetType" >						   
							...
							<option value="0">0-Others</option>
