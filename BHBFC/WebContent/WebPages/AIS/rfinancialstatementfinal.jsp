				...
				<div class="row">
					...
					<div class="col-45">
						<select id="ReportType" name="ReportType"   style="width: 240px;">							
							<option value="TrailBalanceFinal">Trail Balance </option>
							<option value="ProfiteLossStmtFinal">Profit & Loss </option>  						
							<option value="BalanceSheetStmtFinal"> Balance Sheet</option>
