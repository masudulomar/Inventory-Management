...
<body onload="initValues()">
		<center>
		<h2 style="color:#006600;">All Consolidate Report</h2>
				...
				<div class="row">
					...
					<div class="col-75">
						<select id="ReportType" name="ReportType" >		
						    <option value="ConsolidatedIncome">Income [Consolidated] </option>
						    <option value="IndividualIncome">Income [Individual] </option>
						    <option value="ConsolidatedExpenditure">Expenditure [Consolidated] </option>
						    <option value="IndividualExpenditure">Expenditure [Individual] </option>
						    <option value="ConsolidatedCapitalExpenditure">Capital Expenditure [Consolidated] </option>			    				
							<option value="ConsolidatedTBIndividual">Trail Balance [Individual] </option>
							<option value="ConsolidatedTBSummary">Trail Balance [Consolidated ]</option>
							<option value="ConsolidatedProfitAndLoss">Profit & Loss [Consolidated ]</option>
							<option value="ConsolidatedBalanceSheet">Balance Sheet [Consolidated ]</option>
						</select>
					</div>
				</div>
				</fieldset>
