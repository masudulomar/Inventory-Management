			    ...
			    if (obj.ERROR_MSG != "") {
					...
					var select = document.getElementById("glcode");                  
					 ...
					 for(var i = 0; i < gl_arrayList.length; i++) {
					    ...
					    option.value=gl_keyValue[1]+":"+gl_keyValue[0];
	...
	<fieldset>
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-20">
					<select id="glcode" name="glcode"
						onkeypress="GLCodeValidation(event)" style="width: 450px;">
					</select>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-20">
					<select id="DrCrType" name="DrCrType"
						onkeypress="TransationTypeValidation(event)" style="width: 186px;">
			...
			<div class="row">
				...
				<div class="col-20">
					<input type="text" id="chqDate"
						onkeypress="CHQDateValidation(event)">
				</div>
			</div>
		...
		<div class="containerfooter">
			...
			<div class="row">
				...
				<div class="colt-20">
					<textarea id="Remarks" name="Remarks" rows="3" cols="50"></textarea>
				</div>
