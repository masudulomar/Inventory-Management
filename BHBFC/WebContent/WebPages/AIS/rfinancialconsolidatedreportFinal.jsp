...
{	    
	...
	"&AdjustType="+document.getElementById("AdjustType").value+
...
<body onload="initValues()">
		<center>
		<h2 style="color:#006600;">Financial Statement [TB,BS,PL]</h2>
		...
		<fieldset>	
		   <legend>Transaction Details</legend> 			
			   ...
			   <div class="row">
					...
					<div class="col-45">					
						<select id="AdjustType" name="AdjustType"   style="width: 240px;">	
							<option value="B">Before Adjustment</option>
							<option value="A">After Adjustment</option>							
						</select>						
					</div>
				</div>		
				...
				<div class="row">
					...
					<div class="col-45">
						<select id="ReportType" name="ReportType"   style="width: 240px;">							
							<option value="ConsolidateTrailBalanceFinal">Trail Balance </option>
							<option value="ConsolidateProfiteLossStmtFinal">Profit & Loss </option>  						
							<option value="ConsolidateBalanceSheetStmtFinal"> Balance Sheet</option>
