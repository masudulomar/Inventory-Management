	...
	$.ajax({
		  ...
		  .done(function( responseMessage ) {
		    ...
		    if (obj.ERROR_MSG != "") {
				...
				if (obj.PRINCIPAL_AMT!=null) {
					var r = confirm("Data already exists!\nDo you want to update?");
					  if (r == true) {		
						  document.getElementById("PrincipalAmt").value=parseFloat(obj.PRINCIPAL_AMT).toFixed(2); 
							document.getElementById("IntAmt").value=parseFloat(obj.INTEREST_AMT).toFixed(2);							
		...
		<div class="container">
			...
			<input type="submit" id="fetchData" value="Fetch Data" onclick="fethData(event)" >
				...
				<div class="row">
				 ...
				 <div class="row">
					<div class="col-15">
						<label for="IntAmt">Interest Amount</label>
					</div>
					<div class="col-20">
