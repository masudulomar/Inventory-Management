...
<body onload="initValues()">
		...
		<h2 style="color:#006600;">LMS Balance Classification  Report [UC,CL]</h2>
		<div class="container">
		<fieldset>	
				...
				<div class="row">
					...
					<div class="col-45">
						<select id="ReportType" name="ReportType"   style="width: 240px;">		
							<option value="branchloanststusall"> Branch Loan Status[consolidate]</option>
							<option value="branchloanststusNatue"> Branch Loan Status[By Nature]</option>
						</select>
					</div>
				</div>
				</fieldset>
