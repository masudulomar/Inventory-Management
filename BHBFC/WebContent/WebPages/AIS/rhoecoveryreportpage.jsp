...
<body onload="initValues()">
		<center>
		<h2 style="color:#006600;">Recovery & Recoverable Report</h2>
		...
		<fieldset>	
		   <legend>Transaction Details</legend> 			
				...
				<div class="row">
					...
					<div class="col-45">					
						<select id="FinYear" name="FinYear"   style="width: 245px;">	
				...
				<div class="row">
					...
					<div class="col-45">
						<select id="ReportType" name="ReportType"   style="width: 245px;">							  						
							<option value="BranchAndProductWiseRecovery">Recovery Report (Product)</option>
							<option value="BranchWiseRecovery">Recovery Report (Branch Wise)</option>
							<option value="BranchAndProductWiseRecoverable"> Recoverable Report(Product)</option>						
							<option value="BranchWiseRecoverable"> Recoverable Report(Branch Wise)</option>
						</select>
					</div>
				</div>
				</fieldset>
