...
<body onload="initValues()">
		<center>
		<h2 style="color:#006600;">LMS Classification Report [UC,CL,DF,BD]</h2>
		...
		<fieldset>	
		   <legend>Transaction Details</legend> 			
				...
				<div class="row">
					...
					<div class="col-45">
						<select id="StatusType" name="StatusType"   style="width: 245px;">							
				...
				<div class="row">
					...
					<div class="col-45">
						<select id="ReportType" name="ReportType"   style="width: 240px;">		
							<option value="rconsolidatedClassification"> Classification(UC,SS,BD,DF) </option>
						</select>
					</div>
				</div>
				</fieldset>
