...
<body onload="initValues()">
		<center>
		<h2 style="color:#006600;">LMS Balance Slab Report [Principal,Interest]</h2>
				...
				<div class="row">
					...
					<div class="col-45">
						<select id="ReportType" name="ReportType"   style="width: 240px;">		
							<option value="branchloanststusall_slab"> Slab Wise Loan Status[consolidate]</option>
							<option value="branchloanststusNatue_slab"> Slab Wise Status[By Nature]</option>
						</select>
					</div>
				</div>
				</fieldset>
