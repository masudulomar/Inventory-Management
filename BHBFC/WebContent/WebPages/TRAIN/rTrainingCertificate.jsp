...
{	    
	...
	"&NameofInstitute="+document.getElementById("NameofInstitute").value+
	"&SubjectOfTraining="+document.getElementById("SubjectOfTraining").value;
...
<body onload="initValues()">
		<center>
		<h2 style="color:#006600;">Certificate Download</h2>
		   ...
		   <legend> Parameter</legend> 	
			...
			<div class="row">
				...
				<div class="row">
					...
					<div class="col-20">
						<select id="ReportType" name="ReportType"  style="width: 260px;">							
							<option value="rTrainingSubject">Print Report </option>
						</select>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-20">
						<input type="submit" id="report_download" value="Download" onclick="ViewAllReport()" > <br>
					</div>
