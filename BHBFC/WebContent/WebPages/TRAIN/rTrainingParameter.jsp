...
<body onload="initValues()">
		<center>
		<h2 style="color:#006600;">Training Parameter  Report</h2>
				...
				<div class="row">
					...
					<div class="col-75">
						<select id="ReportType" name="ReportType"  style="width: 400px;">							
							<option value="rTrainingInstituteList">Print Training Institute List  </option>
							<option value="rTrainingSubjectList">Print Training Subject List  </option>
						</select>
					</div>
				</div>
				</fieldset>
