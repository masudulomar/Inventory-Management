...
public class MailService {
	...
	public  String MailService(String mailHeader, String mailBody, String UserMail, String UserPassword,
			String bulkMail[], byte[] pdfBytes,String Filename) throws AddressException, MessagingException {
		try {
